...
//    }
    ...
    @PostMapping("/timetable")
    public ResponseEntity<List<TimeTable>> createTimeTable(@RequestBody List<TimeTableInsertDto> timetable, Integer applicantId) {
    ...
    public ResponseEntity<List<TimeTable>> getTimeTables(@PathVariable(name = "applicantId") Integer applicantId) {
