package com.econovation.recruit.api.slack.sender;
...
public class SlackInternalErrorSender {
    ...
    public void execute(ContentCachingRequestWrapper cachingRequest, Exception e, Long userId)
            throws IOException {
        List<LayoutBlock> layoutBlocks = generateSlackErrorLayoutBlocks(cachingRequest, e, userId);
        slackProvider.sendNotification(layoutBlocks);
    }

    private List<LayoutBlock> generateSlackErrorLayoutBlocks(
