...
public class CommonsEmailSender {
    ...
    public void send(String toEmail, String name, String contents){
        ...
        email.setAuthentication(commonsEmailProperties.getSenderAddress(), commonsEmailProperties.getPassword());
        email.setSSLOnConnect(true);
        email.setStartTLSEnabled(true);
        try {
            email.addTo(toEmail, name);
            email.setFrom(commonsEmailProperties.getSenderAddress(), commonsEmailProperties.getSenderName());
