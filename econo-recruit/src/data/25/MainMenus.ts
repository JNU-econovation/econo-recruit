...
export const MAIN_MENU = [
  { title: '25 PAGE', subtitle: '신입모집 신청 페이지', href: '/application/25' },
  { title: 'KANBAN BOARD', subtitle: '신입모집 칸반보드', href: '/kanban/25' },
  { title: 'INTERVIEW', subtitle: '신입모집 면접 기록', href: '#' },
  { title: 'APPLICANT VIEW', subtitle: '신입모집 지원현황', href: '/applicant/25' },
