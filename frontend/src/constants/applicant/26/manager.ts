export const APPLICANT_MANAGER = [
  ...
  } as ApplicantTextareaNode,
  {
    id: 7,
    title:
      "PM(기획자)은 아이디어를 낼 뿐만 아니라, 자신의 아이디어를 동료들이 이해할 수 있는 형식으로 효과적으로 전달해야 하는 역활입니다. 지원자님께서 자신의 아이디어를 시각적으로 구현하여, 구체적으로 전달한 경험이 있다면 서술해 주세요. 어떤 아이디어를 어떤 형태로 구현하여, 누구에게 전달했는지 잘 드러나도록 작성해 주세요.",
    type: "textarea",
    value: { name: "future" },
  } as ApplicantTextareaNode,
  {
